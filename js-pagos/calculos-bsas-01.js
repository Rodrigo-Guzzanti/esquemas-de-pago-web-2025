document.addEventListener('DOMContentLoaded', function()  {
    ...
    function calcularValorDinamico1(distancia) {
        ...
        if (distancia <= 1.5) {
            amount = distancia * tarifasValores[13].tarifasValores1;
        } else if (distancia <= 2.5) {
            amount =
                (1.5 * tarifasValores[13].tarifasValores1) +
                ((distancia - 1.5) * tarifasValores[14].tarifasValores1);
        } else if (distancia <= 4) {
            amount =
                (1.5 * tarifasValores[13].tarifasValores1) +
                (1.0 * tarifasValores[14].tarifasValores1) +
                ((distancia - 2.5) * tarifasValores[15].tarifasValores1);
        } else {
            amount =
                (1.5 * tarifasValores[13].tarifasValores1) +
                (1.0 * tarifasValores[14].tarifasValores1) +
                (1.5 * tarifasValores[15].tarifasValores1) +
                ((distancia - 4) * tarifasValores[16].tarifasValores1);
        }
    ...
    function calcularValorDinamico2(distancia) {
        ...
        if (distancia <= 2) {
            amount = distancia * tarifasValores[12].tarifasValores2;  // 👈 Asegura que desde 0 hasta 1.5 km se use tramo 1
        } else if (distancia > 2 && distancia <= 4) {
            amount =
                (2 * tarifasValores[13].tarifasValores2) + 
                ((distancia - 2) * tarifasValores[13].tarifasValores2);
        } else if (distancia > 4 && distancia <= 6) {
            amount =
                (2 * tarifasValores[12].tarifasValores2) +
                (1.0 * tarifasValores[13].tarifasValores2) +
                ((distancia - 4) * tarifasValores[14].tarifasValores2);
        } else {
            amount =
                (2 * tarifasValores[12].tarifasValores2) +
                (1.0 * tarifasValores[13].tarifasValores2) +
                (2 * tarifasValores[14].tarifasValores2) +
                ((distancia - 6) * tarifasValores[15].tarifasValores2);
        }
