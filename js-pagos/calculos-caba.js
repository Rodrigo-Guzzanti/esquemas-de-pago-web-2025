document.addEventListener('DOMContentLoaded', function()  {
    ...
    const url = 'https://script.google.com/macros/s/AKfycbwjkHUzcJ4nlQ_oTw5kEN-KMLfN9uJLc3sWhixJNBqjaxN9bydyB-B5F-YWC7Sn219eQQ/exec?hoja=CABA%20CODIGO';    
...
function calcularValorDinamico2(distancia) {
    ...
    function renderTable1() {
        ...
        const lastRowsToShow = diasSemana.length; // Asegurar que se rendericen todas las filas necesarias
        const rowsToShow = data.slice(-lastRowsToShow);
        ...
        rowsToShow.forEach((record, index) => {
            ...
            if (index === diasSemana.length - 5) { // Asegurar que se coloca en el inicio del grupo
                const adicionalCell = document.createElement('td');
                adicionalCell.textContent = 'Adicional por grupo';
                adicionalCell.setAttribute('rowspan', 5); // Se extiende a los cinco grupos
