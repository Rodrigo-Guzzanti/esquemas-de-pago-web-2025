document.addEventListener('DOMContentLoaded', function()  {
    ...
    function calcularValorDinamico2(distancia) {
        ...
        if (distancia <= 1.5) {
            ...
            amount = ((distancia - 1.5) * tarifasValores[13].tarifasValores2) + (1.5 * tarifasValores[12].tarifasValores2);
        } else if (distancia <= 4) {
            amount = ((distancia - 2.5) * tarifasValores[14].tarifasValores2) + (1 * tarifasValores[13].tarifasValores2) + (1.5 * tarifasValores[12].tarifasValores2);
        } else if (distancia <= 8) {
            amount = ((distancia - 6) * tarifasValores[15].tarifasValores2) + (1.5 * tarifasValores[14].tarifasValores2) + (1 * tarifasValores[13].tarifasValores2) + (1.5 * tarifasValores[12].tarifasValores2);
        }
