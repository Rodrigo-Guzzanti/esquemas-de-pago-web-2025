document.addEventListener('DOMContentLoaded', function()  {
    ...
    const url = 'https://script.google.com/macros/s/AKfycbwjkHUzcJ4nlQ_oTw5kEN-KMLfN9uJLc3sWhixJNBqjaxN9bydyB-B5F-YWC7Sn219eQQ/exec?hoja=Bs%20As%202%20CODIGO';    
    ...
    function calcularValorDinamico2(distancia) {
        ...
        if (distancia <= 2) {
            ...
            amount = ((distancia - 4) * tarifasValores[15].tarifasValores2) + (1 * tarifasValores[14].tarifasValores2) + (2 * tarifasValores[13].tarifasValores2);
        } else if (distancia <= 8) {
            amount = ((distancia - 6) * tarifasValores[16].tarifasValores2) + (2 * tarifasValores[15].tarifasValores2) + (1 * tarifasValores[14].tarifasValores2) + (2 * tarifasValores[13].tarifasValores2);
        }
  ...
  function renderTable1() {
    ...
    rowsToShow.forEach((record, index) => {
        ...
        if (index === diasSemana.length - 4) { // Asegurar que se coloca en el inicio del grupo
