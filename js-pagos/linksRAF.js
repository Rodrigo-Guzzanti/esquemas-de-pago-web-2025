document.addEventListener('DOMContentLoaded', function () {
  const scriptURL =
    'https://script.google.com/macros/s/AKfycbyYkSXnvfWpNHvrJPu6s3lbYl7rued2SDM2XvA58jh4CBfoLcRnE3FNRSq_ynLmH_Kr6A/exec';
  ...
  if (img) {
    img.id = fileName;
    img.src =
      'https://braze-images.com/appboy/communication/assets/image_assets/images/67b47bb5bb5dc900650b683c/original.gif?1739881397'; // Imagen de carga
  }
